            ...
            <div class="container-fluid">
              <div class="row">
               <div class="col-md-5 col-lg-5">
                 ...
                 <hr />
                 <form role="form" action="{{url('/handlePrepare')}}" method="POST" enctype="multipart/form-data">
               ...
               <div class="col-xs-2 col-xs-offset-2 col-sm-2 col-sm-offset-2 col-md-2 col-md-offset-2 col-lg-2 col-lg-offset-2">
                 <ul class="nav nav-pills nav-stacked sidebar">
                   <li role="presentation" class="active"><a href="{{url('adminprepare')}}"><i class="fa fa-plus"></i> New</a></li>
