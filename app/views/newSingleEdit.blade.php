            ...
            <div class="container-fluid">
              <div class="row">
               <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                 ...
                 <hr />
                 <form role="form" action="{{url('/editNew/'.$news->id)}}" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                     <label>Heading</label>
                     <input type="text" class="form-control" name="heading" value="{{$news->heading}}" placeholder="Enter heading" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     <label>Content</label>
                     <textarea class="form-control" name="content" rows="3" required>{{$news->content}}</textarea>
                    </div>
                    <div class="form-group">
                     <label>File input</label>
                     <input type="file" name="file" required>
                     <p class="help-block">{{$news->file}}</p>
                    </div>
