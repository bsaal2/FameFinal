                 ...
                 <tbody>
                   @forelse ($news as $news)
                    <tr>
                      ...
                      <td class="text-center"><a href="{{URL::to('adminnewsingleview/'.$news->id)}}"><i class="fa fa-eye"></i></a></td>
                      <td class="text-center"><a href="{{URL::to('adminnewsingledelete/'.$news->id)}}"><i class="fa fa-trash"></i></a></td>
                      <td class="text-center"><a href="{{URL::to('adminnewsingleedit/'.$news->id)}}"><i class="fa fa-pencil-square"></i></a></td>
                    </tr>
                    @empty
