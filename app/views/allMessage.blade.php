                 ...
                 <tbody>
                   @forelse ($msg as $msg)
                    <tr>
                      ...
                      <td class="text-center"><a href="{{URL::to('adminmessagesingleview/'.$msg->id)}}"><i class="fa fa-eye"></i></a></td>
                      <td class="text-center"><a href="{{URL::to('adminmessagesingledelete/'.$msg->id)}}"><i class="fa fa-trash"></i></a></td>
                      <td class="text-center"><a href="{{URL::to('adminmessagesingleedit/'.$msg->id)}}"><i class="fa fa-pencil-square"></i></a></td>
                    </tr>
                    @empty
