                 ...
                 <tbody>
                   @forelse ($gallary as $gallary)
                    <tr>
                      ...
                      <td class="text-center"><a href="{{URL::to('admingallarysingleview/'.$gallary->id)}}"><i class="fa fa-eye"></i></a></td>
                      <td class="text-center"><a href="{{URL::to('admingallarysingledelete/'.$gallary->id)}}"><i class="fa fa-trash"></i></a></td>
                      <td class="text-center"><a href="{{URL::to('admingallarysingleedit/'.$gallary->id)}}"><i class="fa fa-pencil-square"></i></a></td>
                    </tr>
                    @empty
