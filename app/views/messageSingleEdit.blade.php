            ...
            <div class="container-fluid">
              <div class="row">
               <div class="col-md-5 col-lg-5">
                 ...
                 <hr />
                 <form role="form" action="{{url('/editMessage/'.$msg->id)}}" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                     <label>Heading</label>
                     <input type="text" class="form-control" name="heading" value="{{$msg->heading}}" placeholder="Enter heading" required>
                    </div>
                    <div class="form-group">
                     <label>Message</label>
                     <textarea class="form-control" name="content" rows="3" required>{{$msg->content}}</textarea>
                    </div>
                    <div class="form-group">
                     <label>File input</label>
                     <input type="file" name="file" required>
                     <p class="help-block">{{$msg->file}}</p>
                    </div>
