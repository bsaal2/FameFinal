                 ...
                 <tbody>
                   @forelse ($slider as $slider)
                    <tr>
                      ...
                      <td><a href="{{URL::to('adminslidersingleview/'.$slider->id)}}"><i class="fa fa-eye"></i></a></td>
                      <td><a href="{{URL::to('adminslidersingledelete/'.$slider->id)}}"><i class="fa fa-trash"></i></a></td>
                      <td><a href="{{URL::to('adminslidersingleedit/'.$slider->id)}}"><i class="fa fa-pencil-square"></i></a></td>
                    </tr>
                    @empty
