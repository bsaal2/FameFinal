            ...
            @foreach($news as $news)
						...
						<div class="single-blog-post">
							...
							<div class="img-holder">
								<img src="{{'http://localhost/ProjectFame1/fame/app/storage/uploaded/'.$news->file}}" alt="{{$news->file}}">
							...
							<div class="post-meta">
								...
								<div class="title-holder">
									<h2 class="title">{{$news->heading}}</h2>
									<ul>
										<li><a href="#">Posted By: Admin </a></li>
										<li><a href="#">Categories: {{$news->category}}</a></li>
									</ul>
								</div>
							</div><!-- /.post-meta -->
							<!-- .content -->
